...
{
    [ACClassInfo("mycompany.erp", "en{'Purchase Order'}de{'Bestellung'}", Global.ACKinds.TACBSO, Global.ACStorableTypes.NotStorable, true, true, Const.QueryPrefix + InOrder.ClassName)]
    public class BSOInOrder : BSOMyCompNav
    {
        ...
        [ACPropertyAccessPrimary(9999, InOrder.ClassName)]
        public ACAccessNav<InOrder> AccessPrimary
        {
            get
            {
                if (_AccessPrimary == null && ACType != null)
                {
                    ...
                    _AccessPrimary = acQueryDef.NewAccessNav<InOrder>(InOrder.ClassName, this);
                    _AccessPrimary.NavSearchExecuting += _AccessPrimary_NavSearchExecuting;
                }
        ...
        [ACPropertyList(300, InOrder.ClassName, "en{'Purchase Order Lisat'}de{'Bestellliste'}")]
        ...
        [ACPropertyCurrent(301, InOrder.ClassName, "en{'Purchase Order'}de{'Bestellung'}")]
        ...
        [ACPropertySelected(302, InOrder.ClassName, "en{'Purchase Order'}de{'Bestellung'}")]
        ...
        void OnPrinting_NewCell(object sender, PaginatorNewTableCellEventArgs e)
        {
            if (e.FieldName == "TargetQuantity" && e.FieldValue != null && e.FieldValue is double)
            {
                ...
                if (value > 0.0001)
                {
                    string valueAsString = InlineValueBase.FormatValue(value, "0.0000", (e.TableRow as TableRowDataBase).CultureInfo, (e.TableRow as TableRowDataBase).MaxLength);
